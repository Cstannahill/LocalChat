...
public sealed class SessionStateExtractionEventConfiguration : IEntityTypeConfiguration<SessionStateExtractionEvent>
{
    public void Configure(EntityTypeBuilder<SessionStateExtractionEvent> builder)
    {
        builder.ToTable("SessionStateExtractionEvents");
